      ...
      <div className="boxprincipal">
        ...
        <Col md="6">
              <Card className="card-chart">
                <CardHeader>
                  <CardTitle tag="h5">Investimentos</CardTitle>
                </CardHeader>
                <CardBody>
                  <Line
                ...
                <CardFooter>
                  <div className="chart-legend">
                    <i className="fa fa-circle text-success" />Investimentos de baixo Risco{" "}
                    <i className="fa fa-circle text-danger" /> Investimentos de baixo Risco
                  </div>
                  <hr />
                  <div className="card-stats">
                    <i className="fa fa-check" /> última atualização: 04/07/2020 08:45:00
                  </div>
                </CardFooter>
              </Card>
            </Col>
